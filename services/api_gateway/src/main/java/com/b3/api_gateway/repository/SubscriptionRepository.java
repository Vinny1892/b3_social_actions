...
public class SubscriptionRepository {
    ...
    public Map createSubscription(Map dto) throws Exception {
    ...
    public Map getAllSubscriptions(int page, int size) throws Exception {
    ...
    public Map deleteSubscription(UUID id) throws Exception {
